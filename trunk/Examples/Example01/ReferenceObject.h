...
public:
	...
	REFERENCE<TYPE, OBJECT_TYPE>* GetPrevReference(REFERENCE<TYPE, OBJECT_TYPE>* Reference) CONST;
...
VOID REFERENCE_OBJECT<TYPE, OBJECT_TYPE>::Clear()
{
	...
	while(CurrentReference != NULL)
	{
		...
		CurrentReference->PrevReference = NULL;
...
//+-----------------------------------------------------------------------------
template <class TYPE, class OBJECT_TYPE>
REFERENCE<TYPE, OBJECT_TYPE>* REFERENCE_OBJECT<TYPE, OBJECT_TYPE>::GetPrevReference(REFERENCE<TYPE, OBJECT_TYPE>* Reference) CONST
{
	if (Reference == NULL) return NULL;
...
VOID REFERENCE_OBJECT<TYPE, OBJECT_TYPE>::Add(REFERENCE<TYPE, OBJECT_TYPE>* Reference)
{
	...
	Reference->PrevReference = LastReference;
...
VOID REFERENCE_OBJECT<TYPE, OBJECT_TYPE>::Remove(REFERENCE<TYPE, OBJECT_TYPE>* Reference)
{
	if (Reference->NextReference == NULL)
	{
		...
		{
			LastReference = Reference->PrevReference;
	...
	else
	{
		if (Reference->PrevReference == NULL)
		{
			...
			FirstReference->PrevReference = NULL;
		}
		else
		{
			Reference->PrevReference->NextReference = Reference->NextReference;
			Reference->NextReference->PrevReference = Reference->PrevReference;
		}
	}
